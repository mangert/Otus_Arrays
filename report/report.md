...
# Задание2. Анализ производительности структур данных
...
- Ссылка на реализацию - [`PriorityQueue.h)`](../headers/PriorityQueue.h)
  ...
  - Приоритеность реализована как дискретная (для непрерывного приоритетам список списков или массив массивов, как в задании, неоптимально и даже бессмысленно)
...
- При тестировании выполнялось два вида сценариев:
	...
	# полученные усреденные результаты: 
