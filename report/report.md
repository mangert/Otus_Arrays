...
- Ссылка на консольный вывод ***результатов тестирования*** - [`queue_test_output.txt`](queue_test_output.txt)
#
...
#### В этих сценариях использовалась очередь из строк для возможности визуальной проверки соблюдения приоритета извлечения. Результат показал корректность работы очереди
